      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <motion.h1
            ...
            className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold text-primary-foreground mb-6 leading-tight tracking-wide"
          >
          ...
          <motion.p
            ...
            className="font-body text-lg md:text-xl text-primary-foreground/90 mb-10 max-w-2xl mx-auto leading-relaxed"
          >
          ...
          <motion.p
            ...
            className="text-primary-foreground/60 text-sm font-body"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <AnimatedSection key={item.title} delay={i * 0.15}>
                <div className="bg-card rounded-lg p-8 text-center shadow-sm hover:shadow-md transition-shadow h-full">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <AnimatedSection key={kpi.label} delay={i * 0.1}>
                <div className="text-center p-6 rounded-lg bg-primary-foreground/5 border border-primary-foreground/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <AnimatedSection key={s.title} delay={i * 0.2}>
                <div className="group rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow bg-card h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <AnimatedSection key={card.title} delay={i * 0.15}>
                <div className="bg-card rounded-lg p-8 text-center shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-dona/10 text-dona mb-6 mx-auto">
                    {card.icon}
                  </div>
